...
function FindHikeCon(props) {
    return (
        <div className="uk-container-expand findHikeCon">
            <h1 className="uk-text-center">Find Your Adventure</h1>
            ...
            <div className="searchAndResults uk-grid-large uk-grid" uk-grid="true">
                {props.children[0]}
                <div className="uk-width-2-3@m uk-width-1-1@s uk-grid resultsList">
                    <h2 className="resultsHeader uk-width-1-1 uk-text-center"><span uk-icon="icon: list; ratio: 1.5"></span> Results List</h2>
